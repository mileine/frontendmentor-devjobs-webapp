...
export default function Header() {
  ...
  if (!mounted) {
    return (
      <header className="bg-header-mobile md:bg-header-tablet lg:bg-header-desktop bg-cover bg-no-repeat h-[136px] md:h-[160px] flex items-center justify-between px-6 md:px-10 lg:px-40">
        <div className="container mx-auto flex items-center justify-between">
          <h1 className="text-white text-2xl md:text-3xl font-bold">devjobs</h1>
    ...
    <header className="bg-header-mobile md:bg-header-tablet lg:bg-header-desktop bg-cover bg-no-repeat h-[136px] md:h-[160px] flex items-center justify-between px-6 md:px-10 lg:px-40">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="w-12 h-6 bg-white rounded-full relative transition-all"
            aria-label="Toggle theme"
          >
            <div
              className={`absolute top-1 w-4 h-4 bg-violet rounded-full transition-transform ${
