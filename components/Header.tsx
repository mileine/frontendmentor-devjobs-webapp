...
export default function Header() {
  ...
  if (!mounted) {
    return (
      <header className="bg-header-mobile md:bg-header-tablet lg:bg-header-desktop bg-cover bg-center bg-no-repeat h-[136px] md:h-[160px] md:rounded-bl-[100px] relative">
        <div className="w-full h-full flex items-center px-6 md:px-[39px] lg:px-[165px]">
          <div className="w-full max-w-[1440px] mx-auto flex items-center justify-between">
            <Link href="/" className="text-white text-[26px] md:text-[32px] font-bold hover:opacity-80 transition-opacity tracking-tight">
              devjobs
            </Link>
  ...
  return (
    <header className="bg-header-mobile md:bg-header-tablet lg:bg-header-desktop bg-cover bg-center bg-no-repeat h-[136px] md:h-[160px] md:rounded-bl-[100px] relative">
      <div className="w-full h-full flex items-center px-6 md:px-10 lg:px-[165px]">
        <div className="w-full max-w-[1440px] mx-auto flex items-center justify-between">
          <Link href="/" className="text-white text-[26px] md:text-[32px] font-bold hover:opacity-80 transition-opacity tracking-tight">
            devjobs
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="w-12 h-6 bg-white rounded-full relative transition-all hover:bg-white/90"
            aria-label="Toggle theme"
          >
            <div
              className={`absolute top-1 w-4 h-4 bg-violet rounded-full transition-transform duration-300 ${
